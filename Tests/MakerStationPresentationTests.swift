...
final class MakerStationPresentationTests: XCTestCase {
    ...
    func testGearPresentationCopyUsesNaturalStockCountsAndOlderSaveCopy() {
        ...
        XCTAssertEqual(GearPresentationCopy.quality(.rough), "Rough")
        XCTAssertEqual(GearPresentationCopy.quality(.standard), "Standard")
        XCTAssertEqual(GearPresentationCopy.quality(.fine), "Fine")
        XCTAssertEqual(GearPresentationCopy.quality(.superior), "Superior")
        XCTAssertEqual(GearPresentationCopy.quality(.exceptional), "Exceptional")
        XCTAssertEqual(GearPresentationCopy.quality(.peerless), "Peerless")
