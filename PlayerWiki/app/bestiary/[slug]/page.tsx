...
export default async function BestiaryDetail({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <SiteFrame sidebar>
    ...
    <RelatedGuides links={[{ label: 'All Bestiary profiles', href: '/bestiary' }, { label: 'Exploration', href: '/systems/exploration' }, { label: 'Combat', href: '/systems/combat' }, { label: 'Animals and companionship', href: '/systems/animals-companionship' }]} />
  </SiteFrame>;
}
