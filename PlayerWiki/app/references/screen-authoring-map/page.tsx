  ...
  return <SiteFrame sidebar>
    ...
    <section className="article-section" aria-labelledby="screen-tree-heading">
      <div className={styles.sectionHeading}>
        ...
        <span>Checked 2 September 2026</span>
      </div>
    ...
    <section className="article-section note-card" aria-labelledby="how-to-read-heading">
      ...
      <p>This records presentation progress only. It does not claim that a station is unlocked, that its rules are final, or that a pending redesign should be implemented.</p>
    </section>
  </SiteFrame>;
}
