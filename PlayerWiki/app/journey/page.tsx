  ...
  return (
    ...
    <SeptemberDecisions topic="progression" />
      ...
      <section className="article-section note-card">
        ...
        <p><strong>Current behavior:</strong> the return summary names the recorded cause that brought you down, such as poison or a known creature’s attack, delivered in build317.</p>
        <p><strong>Retained rules:</strong> unknown causes stay unknown, and a companion falling alone is not a party defeat. Revival and haul rules remain the same. Essence recovery changes are deferred.</p>
