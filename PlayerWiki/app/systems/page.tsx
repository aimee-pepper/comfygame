...
export default function SystemsHub() {
  ...
  const groups = [
    ...
    },
    {
      ...
      links: [['Combat', '/systems/combat'], ['Party, Gear and Gambits', '/systems/party-preparation'], ['Field supplies', '/systems/field-supplies'], ['Equipment', '/equipment'], ['Consumables', '/consumables']],
    },
    {
