...
export default function SystemsHub() {
  ...
  return <SiteFrame sidebar><PageIntro eyebrow="Player guides" title="Systems" summary="Choose a guide by the question you have right now: how to begin, what to prepare, where to craft, or which Village screen and reference table you need." />
    ...
    <section className="article-section note-card"><h2>Field and Village references</h2><p>When a revealed world feature, Village foundation, or encounter needs a name, open the current profile first; neither directory marks it as discovered in your own campaign.</p><nav aria-label="Field and Village reference directories"><Link href="/village">Village buildings</Link><Link href="/bestiary">Bestiary profiles</Link><Link href="/sites">Site directory</Link><Link href="/resources">Resources</Link></nav></section>
