  ...
  const groups = [
    {
      ...
      links: [['Getting started', '/getting-started'], ['World Writing', '/systems/world-writing'], ['Exploration', '/systems/exploration']],
    },
    {
      ...
      links: [['Combat', '/systems/combat'], ['Party, Gear and Gambits', '/services/party-and-gear'], ['Equipment', '/equipment'], ['Consumables', '/consumables']],
    },
    {
