  ...
  const groups = [
    {
      ...
      links: [['Getting started', '/getting-started'], ['Your current journey', '/journey'], ['World Writing', '/systems/world-writing'], ['Exploration', '/systems/exploration'], ['Animals and companionship', '/systems/animals-companionship'], ['Research', '/systems/research']],
    },
    {
      ...
      links: [['Combat', '/systems/combat'], ['Party, Gear and Gambits', '/systems/party-preparation'], ['Equipment and material effects', '/systems/equipment-materials'], ['Field supplies', '/systems/field-supplies'], ['Equipment', '/equipment'], ['Consumables', '/consumables']],
    },
    {
