...
export default function CombatTechniquesAndGambitsGuide() {
  ...
  return <SiteFrame sidebar>
    ...
    <RelatedGuides links={[{ label: 'Combat', href: '/systems/combat' }, { label: 'Party, Gear and Gambits', href: '/systems/party-preparation' }, { label: 'Research', href: '/systems/research' }, { label: 'Equipment', href: '/equipment' }, { label: 'All systems', href: '/systems' }]} />
  </SiteFrame>;
}
