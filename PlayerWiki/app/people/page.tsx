...
export default function PeoplePage() {
  ...
  return <SiteFrame sidebar><PageIntro eyebrow="Reference" title="People" summary="Meet the travellers and village specialists in campaign order. A person’s page keeps their work, diary sequence, and the boundaries around discovery together." />
    <section className="article-section note-card"><h2>Read each person at the right moment</h2><p>A traveller’s name and meeting context are useful after the Library names someone to seek. Each linked record keeps that person’s authored pages together, including their location-hint stages behind a clear spoiler boundary.</p></section>
