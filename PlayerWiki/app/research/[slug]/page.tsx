...
export default async function ResearchNodeDetail({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <SiteFrame sidebar>
    ...
    <RelatedGuides links={[{ label: 'All Research', href: '/research' }, { label: 'Library', href: '/buildings/library' }, ...(station ? [{ label: station.name, href: `/buildings/${station.slug}` }] : []), { label: 'All resources', href: '/resources' }]} />
  </SiteFrame>;
}
