...
export default function RecyclingDirectory() {
  ...
  return <SiteFrame sidebar>
    ...
    <section className="article-section"><h2>Materials returned today and after the approved update</h2><TruthPair current="The Recycler dismantles one exact eligible piece. Receipt-backed gear returns selected source samples; older standard gear follows its stated salvage profile." accepted="The same exact-piece rules remain, but returned physical stock becomes exact subtype, quality-band, and quantity stacks with its species-specific items retained underneath. The Recycler will never silently substitute another band." /></section>
