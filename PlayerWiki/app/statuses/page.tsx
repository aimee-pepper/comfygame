...
export default function StatusDirectory() {
  return <SiteFrame sidebar>
    ...
    <DirectoryIndex label="Browse conditions and effects" entries={statusReferences.map((status) => ({ href: `/statuses/${status.slug}`, name: status.name }))} />
    <DirectoryDetailsIntro title="Compare conditions and effects" summary="Check the current result, boundary, duration, and clearing rule before opening the full reference." />
