...
export default async function StatusDetail({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <SiteFrame sidebar>
    ...
    <RelatedGuides links={[{ label: 'All conditions and effects', href: '/statuses' }, { label: 'Combat', href: '/systems/combat' }, { label: 'Combat supplies', href: '/systems/field-supplies' }, { label: 'All consumables', href: '/consumables' }, { label: 'Exploration', href: '/systems/exploration' }]} />
  </SiteFrame>;
}
