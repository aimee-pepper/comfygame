...
export default function GettingStarted() {
  ...
  return <SiteFrame sidebar><PageIntro eyebrow="Start here" title="Getting started" summary="Bookbinder alternates between preparing at home, writing a world, exploring it, and bringing discoveries back to strengthen the next expedition." />
    ...
    <section className="article-section"><h2>The intended first Writing lesson</h2><TruthPair current={starterRuneFlow.current} accepted={starterRuneFlow.intended} acceptedLabel="Locked intended opening" /><p><strong>If the introduction is interrupted:</strong> {starterRuneFlow.recovery}</p><p><strong>Existing campaigns:</strong> {starterRuneFlow.legacy}</p></section>
