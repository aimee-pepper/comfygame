...
export default async function TechniqueDetail({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <SiteFrame sidebar>
    ...
    <RelatedGuides links={[{ label: 'All techniques and Gambits', href: '/techniques' }, { label: 'Combat', href: '/systems/combat' }, { label: 'Party, Gear and Gambits', href: '/systems/party-preparation' }, { label: 'Combat techniques and Gambits guide', href: '/systems/combat-techniques-gambits' }, { label: 'Equipment', href: '/equipment' }, { label: 'Research directory', href: '/research' }]} />
  </SiteFrame>;
}
