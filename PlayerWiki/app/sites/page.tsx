...
export default function SitesDirectory() {
  return <SiteFrame sidebar>
    ...
    <RelatedGuides links={[{ label: 'Sites and hazards guide', href: '/systems/sites-hazards' }, { label: 'Exploration', href: '/systems/exploration' }, { label: 'People and complete records', href: '/people' }, { label: 'Resources', href: '/resources' }, { label: 'Bestiary', href: '/bestiary' }]} />
  </SiteFrame>;
}
