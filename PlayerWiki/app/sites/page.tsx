import { PortalSiteDirection } from '@/components/portal-site-direction';
...
export default function SitesDirectory() {
  return <SiteFrame sidebar>
    ...
    <section className="article-section note-card"><h2>Clues in people’s books</h2><p>Some book pages contain location clues, which are clearly marked as spoilers on each person’s page. Compare those clues with the sites listed here, but remember that a clue does not guarantee a site exists in a world you have not explored.</p><p><Link href="/people">Browse people and their books</Link></p></section>
    <PortalSiteDirection />
