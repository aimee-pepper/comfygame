...
export default function WorldReferencePage() {
  ...
  return <SiteFrame sidebar><PageIntro eyebrow="Field reference" title="World conditions, terrain, and Flora" summary="Use this reference to understand the current world facts you can inspect without predicting a bound map’s hidden tiles, deposits, sites, creatures, or exact Flora." />
    ...
    <section className="article-section"><h2>Current generator and intended ecology</h2><TruthPair current="The current generator binds a deterministic world from eight pressures and preserves its seed and receipt. Its land, water, terrain, Flora, resources, and creatures do not yet form the complete granular regional ecology described by the accepted design." accepted="Ground arrangement and ground material are separate. Terrain, water, light, atmosphere, weather, temperature, and growth constrain compatible Flora, creatures, and resource hosts. If two raw condition candidates conflict, another relevant pressure deterministically chooses between them rather than rejecting the world." acceptedLabel="Intended design" /><div className="table-wrap"><table><thead><tr><th>World layer</th><th>Accepted direction</th></tr></thead><tbody>{worldGenerationPlan.map(([layer, direction]) => <tr key={layer}><td><strong>{layer}</strong></td><td>{direction}</td></tr>)}</tbody></table></div></section>
  </SiteFrame>;
}
