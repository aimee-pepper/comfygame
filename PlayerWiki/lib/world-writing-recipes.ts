...
export const worldWritingRecipes: WorldWritingRecipe[] = [
  {
    ...
    title: 'Stone Hollow',
    availability: 'One of the three already-inscribed World Pages available at the beginning of a campaign. It is read-only; writing the same request yourself uses the ordinary current Bind cost.',
    ...
    preparation: 'The existing Page shows its current 16-Essence departure preview. Bring enough carrying room for the construction materials you mean to keep.',
    uncertainty: 'Stone and ordinary ore are more likely here; the Page does not promise a deposit, safe path, map shape, or enough Iron for every building.',
    links: [
  ...
  },
  {
    ...
    availability: 'After two resolved expeditions, this repeatable World Page may appear among ordinary Page rewards. You can use it only after you actually find it; it is not granted automatically.',
  ...
  },
  {
    ...
    preparation: 'Use the current Bind cost and any selected anchoring premium. Extraction 3 can work Rift-glass and Mercury if found; Extraction 4 is needed for the full Adamant pursuit.',
    uncertainty: 'Several conditions remain unwritten. Rare seams still need the right reachable Stone, Rubble, Ash, height, or Chasm margin; this Page never guarantees a deposit or a safe path to it.',
    links: [
