...
const systemLinks: DesignReferenceLink[] = [
  ...
  { href: '/systems/crafting', title: 'Recipes and ingredient categories', summary: 'Static ingredients, broad types, precise subtypes, previews, quality, and commit rules.' },
  ...
  { href: '/systems/equipment-materials', title: 'Equipment materials and quality', summary: 'How selected materials affect equipment now and in the accepted intended design.' },
