...
export const craftedAppearanceRules = [
  ...
  ['Inventory and history', 'The collapsed icon identifies the material category, without sampling or averaging the colours inside. Build374 adds the accepted Softwood Haft, Hardwood Haft, Iron Collar and Bone Collar pictures in Stockpiles; smaller carried-item views retain earlier artwork. Expand the stack for exact source colours and details. Colour never creates another stack or changes recipe eligibility by itself.'],
] as const;
