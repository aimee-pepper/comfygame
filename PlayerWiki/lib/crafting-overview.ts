...
export const materialScoreBoundary = {
  currentGrade: 'Build376 solid materials use75% actual part expression plus25% source Danger, with one final rounding: Poor0–24, Common25–59, Rare60–84, Exceptional85–100. Hide and Bone retain their delivered rules. The following older grade describes legacy material paths only: the 0–100 grade is separate from the six properties. It averages each contributing trait’s distance from 50, multiplies that extremity by 85, adds up to 25 from Lustre, then limits the result to 0–100. Because unusually low traits can raise this grade, it must not become the new four-band quality formula.',
  ...
  currentExceptions: 'Current creature and Flora harvests derive their values from the body or plant that produced them. Older Trading Post sample paths generate values from a range, and some Recycler returns use fixed records. New solid-material sale and buyback preserve exact source properties and use the delivered four-band prices. The intended system must give those materials values supported by their real source rather than unrelated numbers.',
} as const;

export const materialCustodyFlow = [
  ['Field and combat rewards', 'Build364 presents matching material/subtype/quality totals with exact source variants available inside; distinct storage locations remain separate.', 'Receive mined resources as simple exact-name quantities, flora materials as ungraded physical type/subtype stacks, and creature materials as recognizable physical types or subtypes with quality. Species, colour, world, and inherited values remain available in expanded detail.'],
  ['Expedition Return', 'Supported material-sample rows share totals, but physical lots of the same material can still appear separately. The grouping and icon correction has passed internal checks but is not yet in the installed phone build; it preserves every exact recovered or lost piece and quantity.', 'Decide recovered and lost quantities once for every exact-name mined stack, ungraded flora stack, and subtype-and-quality creature stack. Protected outbound units return first; newly gathered units use a frozen deterministic partition rather than inventory order. Together, recovered and lost equal everything the party carried.'],
  ['Storehouse', 'Matching material/subtype/quality totals expand to exact lots; ordinary flora and plant textiles stay ungraded. Different materials and qualities remain separate.', 'Stack mined resources by exact material and quantity, flora by physical type/subtype, and approved creature materials by precise subtype plus quality. Materials are slot-free and never enter Waiting merely because item slots are full; generated stacks can expand to show species-specific source lots.'],
  ['Trading Post', 'Older supported samples retain their pricing. Build376 solid parts sell for2/4/8/16 Gold by quality and buy back at twice sale, preserving exact source details.', 'Buy and sell mined resources and ordinary flora by exact material or subtype and quantity, or creature materials by subtype, quality band, and quantity. Resold creature stock keeps its band and species/source history.'],
...
export const starterRuneFlow = {
  current: 'Build331 delivers zero learned Subjects, Focuses, Modifiers and Compounds for new campaigns, paired with the generated light introduction, free Home reading, usable Sun writing and connected acquisition routes. The three physical starter World Pages remain separate from knowing their words. Existing campaigns retain knowledge and progress. Build366 delivers pre-payment preparation recovery for newly generated ordinary worlds. The previously refused first blank request passed focused recovery checks with required sources and safe lessons retained. Installation and ordinary launch are verified; the natural acquisition journey remains incomplete.',
  intended: 'A new campaign begins with no known runes. Its first excursion is a broadly generated introductory world with Illumination and Sun guaranteed on a safe unavoidable path. Those discoveries survive return, defeat, interruption, and closing the game. Once both are brought home, Writing teaches Illumination as the subject and Sun as its source; the player joins them and binds the first world they shape themselves. Everything they did not write remains generated. Before charging, preparation must seek a valid layout with the same written properties, source colours and required resources; it cannot remove required sources or teaching to succeed. If preparation fails, nothing is spent or issued. Existing saved worlds stay unchanged.',
  recovery: 'Current in331: interrupted active visits resume normally. After Return, the same saved world provides its unfinished protected lesson route without another payment, Page, expedition outcome or reward roll. Latest collected/depleted state is preserved. If both records are already collected, read them free at Home; no extra visit is needed. Continuation closes when both words are learned.',
  sequence: 'The connected opening first pass follows the two light lessons with actual-evidence water/Iron learning, starting-tool gathering, traveler invitations and useful first shops. Core Subject/Focus lessons can be collected together and read in order; the delivered routes cover missing Subjects, former starter Focuses and13 usable Modifiers. Dormant phase lessons remain deferred. Essence recovery is deferred.',
...
export const worldGenerationPlan = [
  ...
  ['Ground and liquid types', 'Use multiple recognizable dirt, sand, stone, mineral, and liquid types. Water has a local bed and surface height, so a low river and a raised pond can coexist. Legal steps and slopes connect different ground heights. Granite regions can host Granite; Sand can become a glassmaking input.'],
...
export const craftedAppearanceRules = [
  ...
  ['Inventory and history', 'The collapsed icon identifies the material category, without sampling or averaging the colours inside. Build374 adds the accepted Softwood Haft, Hardwood Haft, Iron Collar and Bone Collar pictures in Stockpiles. Build375 uses those pictures and Iron Ingot in the carried-items bar, and improves Stockpiles expanded-detail contrast. Expand the stack for exact source colours and details. Colour never creates another stack or changes recipe eligibility by itself.'],
] as const;
...
export const materialPriceRules = [
  ...
  ['Hide and Skin; older Pelt/Feather and proposed Down/Fin prices only', '3 Gold at Common', '6 Gold at Common'],
  ['Build376 solid materials, including Fur Pelt and both Feather types', '2 / 4 / 8 / 16 Gold by quality', '4 / 8 / 16 / 32 Gold by quality'],
  ['Bone; older Plate/Quill and proposed Fang/Claw/Tusk prices', '4 Gold at Common', '8 Gold at Common'],
