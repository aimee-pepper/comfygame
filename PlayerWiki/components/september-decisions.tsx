...
const updates: Record<DecisionTopic, { current?: string; decided: string; tuning?: string; open?: string }> = {
  ...
  progression: {
    ...
    open: 'An arranged development journey reaches Nessa, the Apothecary, a Salve and use after the next Bind. The first natural trip now returns all required materials with no loss, but Nessa failed her appearance chance. Its 33 Essence affords the next quoted 10-Essence Bind; the full recruitment, building and following-Bind budget remains unproven. Home recovery is free. Phone delivery remains pending. T2 smelting and the first cloth/Leather specialist paths are specified; the wider campaign redesign remains separate work. Current directory order remains current behavior.',
  },
  exploration: {
