...
const updates: Record<DecisionTopic, { current?: string; decided: string; tuning?: string; open?: string }> = {
  ...
  exploration: {
    ...
    open: 'The full development test found connected growing habitat in 296 of 1,000 unwritten worlds, above the 25% review target. Actual Softwood appeared in 293 worlds; habitat and placed sources are separate measures. The original test failed on six Softwood or Coal shortfalls. Three are confirmed shared-space limits; the other three now pass focused runtime checks after protecting scarce required sites before flexible and optional choices. The original full-sample counts have not been remeasured. One map also failed to generate. All placed sources retained reachable working positions. Explicit written early-resource guarantees, natural pacing and phone delivery remain pending. Drainage is not part of this revision; no universal map-completion percentage is fixed.',
  },
  writing: {
