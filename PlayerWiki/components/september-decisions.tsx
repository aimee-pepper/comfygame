...
const updates: Record<DecisionTopic, { current?: string; decided: string; tuning?: string; open?: string }> = {
  ...
  exploration: {
    ...
    open: 'The latest development sample placed all four starter plant sources in 16 of 64 unwritten worlds and 23 of 64 moderate-Sun worlds. The previous habitat check recognized fewer because it counted each terrain region separately. The decided correction counts suitable ground across the connected area, with the same habitat requirements. Its new rate, a full 1,000-world measurement, and complete gathering journeys remain unverified. Drainage is not part of this revision. No universal map-completion percentage is fixed.',
  },
  writing: {
