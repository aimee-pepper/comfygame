...
const updates: Record<DecisionTopic, { current?: string; decided: string; tuning?: string; open?: string }> = {
  ...
  exploration: {
    ...
    open: 'The first test of 1,000 completely unwritten worlds found suitable growing land in only 3.6%, below the intended 25% review target. The root-water correction passes its direct development checks. The adopted gentler unwritten-intensity weights improve soil-condition checks to 30.6%, but actual suitable terrain and source placement have not yet been measured under that change. Drainage is not part of this revision. The Sun-authored map, placed sources, travel and Stability still need verification. No universal map-completion percentage is fixed.',
  },
  writing: {
