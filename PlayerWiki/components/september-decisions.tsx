...
const updates: Record<DecisionTopic, { current?: string; decided: string; tuning?: string; open?: string }> = {
  ...
  exploration: {
    ...
    open: 'The full development test found connected growing habitat in 296 of 1,000 unwritten worlds, above the 25% review target. Actual Softwood appeared in 293 worlds; habitat and placed sources are separate measures. The original test failed on six Softwood or Coal shortfalls. Three are now confirmed shared-space limits; three have legal alternatives and await a runtime fix that protects scarce required sites before flexible and optional choices. One map also failed to generate. All placed sources retained reachable working positions. Natural pacing and phone delivery remain pending. Drainage is not part of this revision; no universal map-completion percentage is fixed.',
  },
  writing: {
