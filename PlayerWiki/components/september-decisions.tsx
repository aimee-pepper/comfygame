...
const updates: Record<DecisionTopic, { current?: string; decided: string; tuning?: string; open?: string }> = {
  ...
  progression: {
    ...
    open: 'An arranged development journey reaches Nessa, the Apothecary, a Salve and use after the next Bind. Two natural trips retained all healing materials. Nessa failed her first appearance chance, then the second world was too dark for her habitat; that trip selected Halloway, who also failed his own chance. Funds are 26 spendable plus 5 raw Essence, quoted as 36 after refining. The next step uses the learned daylight clue to inspect a Sun-written page, not another blind search. Full recruitment and healing-route affordability remain unproven. Home recovery is free. Phone delivery remains pending. T2 smelting and the first cloth/Leather specialist paths are specified; the wider campaign redesign remains separate work. Current directory order remains current behavior.',
  },
  exploration: {
