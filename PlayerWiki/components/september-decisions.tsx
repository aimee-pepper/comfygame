...
const updates: Record<DecisionTopic, { current?: string; decided: string; tuning?: string; open?: string }> = {
  ...
  progression: {
    ...
    open: 'An arranged development journey now reaches Nessa, Return, the Apothecary, a prepared Salve, the next Bind and carried Salve use. Placement exceptions, natural journey pacing and phone delivery remain pending. T2 smelting and the first cloth/Leather specialist paths are specified; the wider campaign redesign remains separate work. Current directory order remains current behavior.',
  },
  exploration: {
