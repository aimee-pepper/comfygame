...
const updates: Record<DecisionTopic, { current?: string; decided: string; tuning?: string; open?: string }> = {
  ...
  exploration: {
    ...
    open: 'The first test of 1,000 completely unwritten worlds found suitable growing land in only 3.6%, below the intended 25% review target. This early gathering problem is under investigation; a local soil-drainage correction remains a proposal. The Sun-authored opening, placed sources, travel and Stability still need verification. No universal map-completion percentage is fixed.',
  },
  writing: {
