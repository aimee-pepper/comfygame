...
export function CarryingProgression() {
  return <section className="article-section note-card">
    ...
    <p><strong>Tested in development:</strong> The two Storehouse projects reach 14 spaces and survive reopening. An arranged opening campaign then paid 10 Essence for its next Bind, entering with 14 spaces and 15 Essence remaining. Separate native checks saved Corrin’s expansion to 23, then Sela’s bonus to 25 after reopening. A separate prepared Simulator playtest also reaches 14 spaces after gathering and returning Salt and making a Leather Guard. Supplied stock makes this a connected feature check, not natural affordability evidence. These checks preserve previous purchases and active expedition contents; the increased capacity applies at the next packing boundary.</p>
    <p><strong>Presentation checked in development:</strong> Updated capacity panels and the full project review are integrated. Cancel keeps the original capacity, and reopening the completed route shows 14 spaces with both projects applied. Missing-stock, next-Bind affordability warnings and save-refusal messages still need visual checks. Prices and purchase rules are unchanged.</p>
    <p><strong>Still to test:</strong> Full natural gathering and later affordability, and physical-phone playthrough. These prices are starting balance values, not a required shopping list. The separate Woven Gloves and Boots recipes now pass native crafting and recovery checks too, without requiring the pack projects.</p>
