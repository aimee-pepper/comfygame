...
export function WorldViewDirection() {
  return <section className="article-section note-card">
    ...
    <p><strong>Build329 corrections:</strong> 3D tiles match the displayed 2D tile size, and opaque trees covering the player’s body or occupied tile participate in the existing fade, including remembered trees. The wood-colour trial menu entry is removed. Full normal-Explore viewport coverage is still pending; the supplied checks are Simulator evidence.</p>
