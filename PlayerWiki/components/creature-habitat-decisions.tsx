...
export function CreatureHabitatDecisions() {
  return <section className="article-section note-card">
    ...
    <p><strong>Next weather/body correction:</strong> The existing cold-water tendency toward extra appendages will apply only to supported water or amphibious creatures with actual liquid habitat. Land creatures and fliers keep ordinary body variation. This correction is specified but not implemented; it adds no weather immunity, material reward or changing-weather simulation.</p>
