...
export function BriarOilMaterialUpdate() {
  return <section className="article-section note-card">
    ...
    <p><strong>Current behavior:</strong> Briar Oil and its older recipe already exist. The new Fibre/Resin compatibility update has now been reported delivered in development; phone availability and natural acquisition remain separate.</p>
