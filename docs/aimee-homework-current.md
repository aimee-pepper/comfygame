...
**Partial progress on the complete player experience:** the Bestiary knowledge and sorting rules are specified. Search, counts and body groups use recorded creatures; older incomplete records remain accessible without guessed habitat or shape. Encountered specimens keep their existing measurements without a new victory requirement. Sorting is not implemented yet, and separate distant-sighting and material-reveal details remain unfinished. The broader experience still needs playtesting.

**Bestiary arrangement — decided:** Sky, Water, Amphibious and Land, with body-shape subcategories: Four-legged, Two-legged, Serpentine, Segmented, Radial, Fish-shaped and Amorphous. Amphibious means creatures suited to both water and land, rather than the Earth animal class. You approved this structure and lifted the Bestiary work hold on 5 September. Its implementation is approved and remains pending. This does not complete the three larger goals above.
