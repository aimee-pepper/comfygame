...
**Next maker design ready for implementation:** Briar Oil can accept the new Stem/Leaf Fibre and Resin while retaining its separate existing flexible-world-resource ingredient, zero Essence cost and current effect. This compatibility update is specified, not delivered. Replacing the third ingredient with an extra Fibre is only a later proposal; it is not a new approval chore blocking the ready work. See [the Briar Oil material update](design-decisions-september-4.html).
