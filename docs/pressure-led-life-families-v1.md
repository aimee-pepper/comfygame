...
**Reviewable proposal, not a rule change:** [Plant support and foliage proportions](plant-support-foliage-proposal-2026-09-08.md) recommends a bounded arrangement-aware response to the fibrous/fleshy findings. It is awaiting Aimee review through PM and does not supersede installed354/current morphology or authorize implementation.
