...
> **Current correction:** Build398 improves some internal movement measurements, but the current phone report still identifies a lit field trailing the character by about half a second and no visible slow-terrain warning before input. Both defects remain open. Earlier checks of a ripple after a move was requested did not verify the requested idle warning. Installation and ordinary launch succeeded; the measured improvements do not establish smooth or correctly aligned movement in the reported campaign.
>
