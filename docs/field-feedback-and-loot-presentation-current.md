...
> **Current390 portals, camp and sides:** Build390 delivers authored stone portals with flowing blue Essence magic and a recognizable Wayfarer’s Camp. Its chest changes from closed to open after a committed search, while the shelter, bedroll and cold hearth remain. Both portal identities keep their actual Return home behavior. Other site families still use unfinished markers. Installation and ordinary phone launch are verified; physical-phone appearance and interactive usability have not been inspected. Build390 darkens textured solid terrain sides to distinguish them from their tops, preserving their source hues and textures. Top surfaces, terrain geometry and existing sight dimming keep their rules. This is a side-contrast correction, not a new lighting system. Delivered portals and the camp keep frozen last-observed appearances with still materials in memory; hidden changes do not refresh them, and unknown objects stay hidden. Older memory without the recorded identity keeps its generic marker until the place is seen again. Build391 restores discernible remembered silhouettes, but they remain very dark; fine detail is not yet verified. Portal flow grants no extra light or sight. Travel, searching, rewards and existing confirmations keep their rules.

> **Current389 shared information panes:** Build389 makes notifications and At this place switch between top and bottom together, using the existing two-tile opposite-edge rule. Movement controls, minimap, Use Tile, Look, carried items and Field Kit stay fixed at the bottom. The map keeps its size, scale and position. Open pane details, the current location, exact Read now links and notification expiry stay intact during the switch. If neither edge is suitable, both panes stay at their existing shared edge rather than jumping back and forth. Details open inward, and notification arrival or expiry alone does not move At this place. Internal checks cover both edges, exact page links, expansion, notification lifetime and safe touch handling. Installation is verified. The earlier launch attempt was blocked by a locked phone; ordinary launch subsequently succeeded in390. Physical appearance and interactive usability remain unverified.

> **Current387 interaction labels:** Build387 makes the interaction button name the action it will perform: Return home, Search site, Collect page, Open cache, Use Atlas Seam, Place Anchor Frame, Survey, Choose tools, or the relevant gathering action. Both existing routes that return you home say Return home. A selected tool no longer appears beneath unrelated actions; a gathering tool is named only when that action uses it. Action costs, availability, refusal explanations and existing confirmations keep their rules. Build387 changed interaction labels only; its installation and ordinary launch were verified. Build388 adds the bounded camera-follow and Apex presentation corrections described here. Build389 adds the shared information-pane placement. Build390 adds authored portals, Wayfarer’s Camp and solid-side contrast. Build391 corrects occupied-site visibility, portal opacity and fringe/remembered-terrain readability. Other site artwork, the reported grey appearance of plants and creatures, and moving lights remain unfinished.

> **Current388 bounded movement response:** Build388 makes the character and view respond together on the existing safe-step path to an already visible neighbouring tile. Selection, alert and work markers stay aligned with that scene. New details, saved world position and the next action still wait for the saved result; a failed save restores the character and view together. Steps involving encounters or other events can still take longer. This is a bounded camera-follow correction, not instant movement everywhere or a completed fix for every visual effect. Installation is verified. The earlier launch attempt was blocked by a locked phone; ordinary launch subsequently succeeded in390. Physical-phone appearance and interactive usability remain unverified. The misleading pending/completion ripple remains removed. Terrain and action costs keep their existing rules. Build396 checks covered a cue after input. Build399 delivers the corrected idle warning before input, with bounded campaign-copy verification. A completed crossing reports its actual total and extra turns; for example, crossing mud can take 4 turns, 3 extra. Ordinary-cost directions must have no slowing ripple; known adjacent slow directions should be indicated while idle, before input. Build397 reduces the delay in matched internal recordings, but movement responsiveness remains unfinished; physical-phone touch-to-visible-movement timing was not measured.

> **Current385 movement correction:** the broad pending/completion ripple is removed. The separate staged slow-cost cue is subsequently delivered393; it requires no artificial stationary phase. Existing terrain costs and saving rules remain; input-to-visible movement delay is still an urgent defect. This supersedes pending-delivery wording below without claiming instant walking.

> **Idle-warning correction — delivered in399:** While your character is standing still, directional ripples should point toward every currently visible, reachable adjacent tile that takes extra turns to cross, before you press a movement control. No tap or pending action is required. Ordinary-cost and inaccessible directions have no slowing ripple, and hidden or merely remembered terrain reveals no new information. The ripples disappear when visible movement starts and return for the known surroundings after you stop. They add no delay, turn cost or saving-progress indicator. Terrain still costs its ordinary world turns, and saving still follows the normal action rules. This supersedes the broader382 pending/completion movement-ripple wording below. It leaves idle collectible glints and saved gathering feedback separate. The cause of the reported walking delay remains under Engineering investigation.

> **12 September reconciliation:** The [current Explore reference](player-wiki-design-decisions-current.md#explore-response-and-readability--installed-in382) separates the requested directional movement ripple and idle collectible glint from the static consequence cues and successful collection described here. Build382 installs the directional ripple and current collectible glint, with bounded internal verification; walking delay and broader visual polish remain open; existing gathering feedback retains its current saved-action and notice-preference rules. Earlier candidate-only integration status and fixed-configuration review instructions below are historical development records, not current production holds.
