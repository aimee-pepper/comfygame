...
**Attachment correction — required before this batch is delivered:** internal visual review found some limbs and dorsal spikes detached from the reshaped bodies. Roots must meet the actual local body surface, including bends, narrow waists and tapered tailside bodies. Supporting limbs keep their planted feet while their visible segments adjust to meet the body; each repeated spine attaches at its own position. This preserves the creature's parts and materials. A creature standing on the ground does not, by itself, prove all its parts are connected. The correction and a focused review of the affected examples remain pending.
