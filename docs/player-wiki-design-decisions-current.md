...
**Encounter crash — still reported on342:** you confirmed the encounter still crashes on your phone with build342 installed. That build contains an attempted fix which passed internal retained-world encounter/reopen checks, but those checks did not establish a fix for the continuing physical crash. Engineering is investigating the new recurrence; the encounter issue remains open.
