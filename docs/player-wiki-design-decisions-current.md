...
**Attachment correction — internal progress, not delivered:** corrected examples now close the reported detached limb and dorsal-spike gaps. Roots follow the actual body surface, while supporting limbs keep their planted feet. Radial and amorphous heads still need a broader visible join: the approved first-pass adjustment seats those heads slightly farther into their supporting body, preserving head size and attached features without adding a neck. That head-only adjustment and a focused review of the same examples remain pending. Standing on the ground or touching at a nearly invisible point does not, by itself, establish a convincing connected form; finished join polish remains incomplete.
