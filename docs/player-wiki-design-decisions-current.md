...
**Appearance update — installed in334:** stripe transitions are softer. Newly generated woody assemblies now use tapered supports and gently bowed, tapered branches; previously saved shapes are not regenerated. An internal woody specimen verified these shapes, while the preserved ordinary expedition used fleshy flora and passed movement, encounter and reopening. That ordinary route does not establish a naturally encountered woody form. Leaf fans, crown refinement and full finish treatment remain incomplete; dense stripe patterns can still lose contrast. The new height-route decision below is **not included in334**.
