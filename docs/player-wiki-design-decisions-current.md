...
**Current startup status — build382:** Build382 is installed with the Explore presentation corrections above. Its ordinary phone launch was not verified because the device was locked; this does not block development. It retains381’s World History saving optimization,379’s specific walking-crash repair,380’s saving and travel-feedback improvements and369’s startup correction. Remaining walking delay and slower first saves stay open. A physical gameplay walkthrough and the earlier reported intermittent opening crash remain unverified; this update does not establish that every startup problem is fixed. The earlier368 startup failure remains part of the record.
...
**Sight edges in 3D — restoration in progress:** The game already distinguishes clear current sight, a vague outer fringe, remembered places and unseen ground. We are checking the 3D presentation against those established states. The intended edge fades outward across never-explored fringe terrain; remembered terrain stays dim without becoming brighter beyond that edge. Unseen ground remains opaque black. Ordinary darkness reduces sight and brightness without blurring the world; actual obscuring air owns its separate softening. Previously discovered non-enemy objects keep their last-observed appearance, while hidden enemies and changes remain concealed. The matched native comparison and any resulting corrections are not yet delivered. This work preserves sight distances, targeting, movement, world colours and the existing controls.
...
**Next atmosphere effects — decided, not delivered:** Falling snow and mixed rain/snow are next. Their artwork is prepared, while integration and review in the normal expedition view remain pending. Snow uses slower compact flakes; mixed weather shows both flakes and rain streaks with their distinct falling speeds. Both may accompany the existing mist. Falling snow does not create ground cover. Smoke, airborne ash and miasma remain accepted later atmosphere work. Existing mist, rain, movement ripples and collectible glints remain in place.
