...
**Current behavior and reports:** Build397 reduces movement delay by reusing sight information already prepared for the view. Visibility, discovery, saving and movement costs are unchanged. In three matched internal video sequences, visible cue-to-arrival time fell from about 0.77–0.79 seconds to 0.29–0.34 seconds. These intervals begin at the cue, not the touch, and are not physical-phone campaign measurements. Installation and ordinary iPhone launch succeeded. Response still needs improvement; instant or uniformly smooth movement and complete Torch light-pool timing are not established. Build396’s bounded movement display fixes remain. In the reviewed movement sequences using normal controls, the party stayed visible, a known slow-terrain cue appeared while stationary and was absent by arrival, and destination details and the crossing notice followed arrival. Newly entered tiles no longer appeared black in the three inspected crossings. These results do not establish instant movement or resolve the whole Torch complaint. Installation and ordinary iPhone launch succeeded. A separate phone material check confirmed the lighting response, without interacting with campaigns; appearance and movement in a normal campaign on the phone remain uninspected. The rule still requires the ripple to clear at the first visible movement without adding a pause. Build396 makes affected steps advance the character, view and visible illuminated area together once the next saved view is ready. Steps that can respond early without a mismatch keep that immediate response. This adds no timer or extra turn and reveals no new surroundings before the saved result. Reducing the underlying preparation delay remains part of the correction.

**Decided intended behavior:** When a step onto known slow terrain is accepted and your character is still stationary, a directional ripple can identify the extra-cost crossing. It vanishes as soon as movement starts or the attempt ends. It adds no waiting time and does not measure saving progress. Ordinary steps have no ripple. A completed slow crossing reports its actual total and extra turns, following your existing notification settings. The character, view and lighting should stay aligned without revealing undiscovered surroundings or causing an extra move.
