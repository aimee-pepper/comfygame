...
**Hide details — correction decided, not yet delivered:** the two reported Common Supple Hide groups differ. The8-unit group has flexibility51, hardness15 and four colours; the2-unit group has flexibility49.5, hardness10 and one colour. Their short details will explain those differences and show the actual colour variants and quantities. Both remain Common quality. Source IDs, raw colour numbers and unfinished-rendering messages will be removed from player details. Exact materials and colours remain preserved; similar names do not make the groups interchangeable.
