...
**Current behavior and reports:** Build393 delivers the known slow-terrain cue and actual-cost notification, and prevents older or mismatched scene updates from replacing the matching character, visibility and lighting state. Native checks verified a four-turn crossing notice. Installation and ordinary iPhone launch succeeded; physical appearance and interactive usability have not been independently inspected. These checks do not establish smooth movement on every step or resolve all movement delay.
