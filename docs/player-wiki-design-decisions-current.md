...
**Current limitations:** Walking delay and several Explore presentation problems remain open. Some previously explored terrain without a saved appearance record can appear as plain tan tiles. The checked screenshot example was outside current sight; it was not a case of partially visible terrain. The reported grey shapes were identified as stationary plants, so their appearance needs correction without assuming all animals need new colours. Directional movement ripples and idle collectible glints are not yet delivered in the normal 3D view. Existing saved-action gathering feedback remains subject to your Mining and gathering results preference.
...
**Decided intended — partial sight and memory:** Partially visible terrain may show a dim, still version of its own ground texture without revealing previously unseen plants, loot or creatures, marking it explored or adding discoveries. Remembered places keep their last-observed appearance; hidden changes do not refresh their resources or effects. Where an older explored tile has no appearance record, its already-known ground family may receive a simple, still matching texture. That fallback does not recreate missing historical details, reveal neighbours or contents, or count as a new sighting. Existing world colours, movement costs, saved progress and fixed controls stay intact.
