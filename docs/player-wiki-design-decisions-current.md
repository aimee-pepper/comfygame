...
**Encounter and message corrections — installed in342:** the correction for the reported encounter-opening crash is installed. Internal verification entered a real encounter from the retained affected world and reopened it with inventory unchanged. Shared event messages now expand to show their wrapped text rather than stopping at two lines, and already-disclosed deposits explain their actual required tool and tier. These changes preserve combat, harvest costs, message timing and hidden information. Installation, device readback and ordinary phone launch are verified; physical encounter interaction remains unconfirmed.
