...
| Later two-mark Moderate Sun into Illumination quote, inspected but not purchased | **Costs 14; would leave 22 from 36** |
...
**Home preparation, verified in development:** the recovered Substrate lesson was read in the Library and taught that target only, at no cost. Existing sources, recipes and materials were unchanged. Nessa’s learned clue was reviewed. The two-mark plain Moderate Sun into Illumination page costs **14 Essence**, leaving 22 from 36; its other seven subjects remain unwritten. It promises neither growing habitat nor a traveller. The quote was inspected but not purchased, and its draft was not saved as a template.

**Clue-led next step:** recreate that same Sun page and take one ordinary journey using it. Sun addresses the second world’s lack of light, while other habitat and arrival requirements still matter. The healing materials are already banked; naturally visible Essence opportunities can help pay for recruitment and building. If the trip returns only the previous 3 spring Essence, 22 would become 25: five short of a 20-Essence foundation plus a later 10-Essence blank Bind. Three naturally earned raw Essence at the verified conversion rate would cover that illustrative gap, but neither those drops nor the later quote are promised.

The bounded test stops on another recruitment failure or an actual combined-budget shortfall. If Nessa joins and real funds cover the foundation and following legal Bind, it can complete Salve preparation, packing and use on that next journey. No repeated search-until-success sequence, free money, forced traveller, price change or arrival-odds change is part of this plan. A third Bind has not been purchased at the verified Home receipt above.
