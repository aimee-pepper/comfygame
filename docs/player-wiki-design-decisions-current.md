...
**Tradeoff:** basal rosettes would look shorter, and fleshy branch fans would occupy more visible space around their unchanged central body. Some rear foliage could still be hidden. You approved this revision and asked to see matched before/after examples of the same plants. Those comparisons will show the result before final visual acceptance. Current build354 remains unchanged pending implementation.
