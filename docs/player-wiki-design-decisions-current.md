...
**Appearance updates — installed in334 and335:** stripe transitions are softer. Newly generated woody assemblies now use tapered supports and gently bowed, tapered branches; previously saved shapes are not regenerated. An internal woody specimen verified these shapes, while the preserved ordinary expedition used fleshy flora and passed movement, encounter and reopening. That ordinary route does not establish a naturally encountered woody form. Build335 adds varied leaf tilt to newly generated broad-leaved woody plants with opposite or alternating leaves. This changes their pose, not leaf count, size, material or attachment, and old saved poses stay unchanged. The leaf refinement has internal specimen evidence; a natural woody encounter and your visual acceptance are still unverified. Long bare supports, sparse crowns and full finish treatment remain unfinished; dense stripe patterns can still lose contrast. The new height-route decision below is **not included in335**.
