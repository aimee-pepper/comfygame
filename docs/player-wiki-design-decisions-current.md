...
**Reusable flora artwork — installed in350 and retained in354, phone entry unverified:** newly bound books use reviewed Blender woody leaves, branches, trunks and fibrous blades in the existing3D view, assembled using each plant’s existing size, arrangement, source colour and saved structure. This adds no new species type, organ, harvest or growth rule. Newly bound books use these reviewed components; existing books and saved plants keep their recorded appearance, including books created with the earlier leaf/branch or trunk artwork. The normal2D view is unchanged. Trunks retain the existing plant structure, with branches and thorns seated on the visible surface. This changes appearance only. The fibrous blade component and its new-book rollout passed internal checks. Build354 retains this artwork. A locked phone prevented the prior launch check, and ordinary entry has not yet been verified for354; usable phone entry and readiness for your playtest have not yet been established. **Unresolved appearance issue:** at ordinary map scale, the stem still dominates these plants and the narrow leaves are difficult to distinguish, especially near the base. The accepted proportion revision below has passed internal checks and awaits phone delivery; the component review does not mean the whole plant’s appearance is finished.

**Needle and frond artwork — installed in354, phone entry unverified:** narrow needles and lobed fronds have passed their limited replacement reviews and new-book rollout checks. Newly bound books now use the reviewed artwork for their existing needle and frond growth; older books keep their saved appearance. Installation is verified, but ordinary phone entry and playtest readiness remain unverified. Visible woody and fibrous growth remains seated and recognizable. The reviewed fleshy examples hide much of their foliage behind a large support. The accepted revision below addresses that whole-plant readability concern; its internal implementation checks and comparison review have passed, while phone delivery and your final visual acceptance remain pending.

## Clearer plant silhouettes — internally verified, phone delivery pending

**Accepted behavior, implemented and internally verified; phone delivery pending:** give leaf-bearing, unbranched fibrous plants slimmer stems and let more of their existing leaf length show. Upright plants keep their height; basal rosettes get a shorter central support so the low leaf cluster defines their shape. Let fleshy branches start at the body’s actual outside and carry their existing foliage beyond it. Unbranched fleshy growth that is currently buried would also attach at the surface.
...
**Tradeoff:** basal rosettes would look shorter, and fleshy branch fans would occupy more visible space around their unchanged central body. Some rear foliage could still be hidden. You approved this revision and asked to see matched before/after examples of the same plants. The completed comparisons show clearer upright leaves, compact basal clusters and fleshy branch fans emerging outside the body. Internal checks also preserved source counts, materials and older saved plants. Your final visual acceptance remains pending. Build355 installation is in progress; build354 remains the last confirmed installed version.
