...
**Decided intended atmosphere:** Show the atmosphere the world actually has: smoke, airborne ash, mist or miasma, with rain or snow where the existing world conditions call for them. Moving air changes the drift of existing effects. Mist banks keep their shapes as they drift past terrain and creatures. Looking around during an expedition does not reshuffle them. Heavier mist increases coverage, while wind controls drift. These visuals do not create new weather damage, slippery ground, puddles, freezing or accumulated snow. Unseen places stay hidden, remembered places show their last-observed state without live weather, and characters, useful objects, warnings and controls remain readable.
