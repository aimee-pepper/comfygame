...
**Needle and frond artwork — component reviews passed, not yet installed:** narrow needles and lobed fronds have passed their limited replacement reviews and new-book rollout checks. Newly bound books will use the reviewed artwork; older books will keep their saved appearance. Phone installation remains pending. Visible woody and fibrous growth remains seated and recognizable. The reviewed fleshy examples hide much of their foliage behind a large support. That whole-plant readability concern remains open; no changes to growth size or attachment positions have been decided.
