...
**Decided remaining texture work:** Stone, sand, ash, rubble and mud sides still use plain world colours while their texture work continues. The correct treatment of liquid and chasm sides also remains unfinished; this update adds no invented floor, wall or rock appearance there. Complete the remaining surfaces without changing their material, height or world colours. Suitable existing artwork may be reused and recoloured; make new artwork where needed. Fuller atmosphere effects remain unfinished; illustrative study mist is not ordinary campaign weather.
