...
**Reusable flora artwork — installed in350 and retained in351, phone entry unverified:** newly bound books use reviewed Blender woody leaves, branches, trunks and fibrous blades in the existing3D view, assembled using each plant’s existing size, arrangement, source colour and saved structure. This adds no new species type, organ, harvest or growth rule. Newly bound books use these reviewed components; existing books and saved plants keep their recorded appearance, including books created with the earlier leaf/branch or trunk artwork. The normal2D view is unchanged. Trunks retain the existing plant structure, with branches and thorns seated on the visible surface. This changes appearance only. The fibrous blade component and its new-book rollout passed internal checks. Build351 retains this artwork. A locked phone prevented the prior launch check, and ordinary entry has not yet been verified for351; usable phone entry and readiness for your playtest have not yet been established. **Unresolved appearance issue:** at ordinary map scale, the stem still dominates these plants and the narrow leaves are difficult to distinguish, especially near the base. A coordinated review of plant proportions is still needed; no replacement proportions have been decided, and the component review does not mean the whole plant’s appearance is finished.
