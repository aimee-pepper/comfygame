...
The native encounter used a prepared foe, so it does not measure how often suitable animals occur or how comfortable the gathering journey feels. Broader compatibility tests retain six failures also reproduced before this reward change; they have not been claimed as fixed. Leather processing, the Leather Guard, complete recipe highlighting, final artwork and phone delivery remain separate work.
