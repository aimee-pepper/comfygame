...
Engineering `bead4f414e75aeeaeaa8dbced80eae2e3a7d2ec5`, tree `32c078966d0316a3ae131e6ef3ad3dcafec3560d`, implements this contract with `earlyFlowingWaterVersion = 1`; absent books preserve the original policy and selected preview/Bind/counterfactual behavior is consistent. The single-cell witness has one owned source, a boundary edge or standing receiver, a nil ordinary tile outlet and a route containing the source once. Infeasible outlets report `singleCellOutletUnavailable` explicitly.

Five focused tests passed in `test_sim_2026-09-05T04-33-47-776Z_pid44441_be6e30cd.xcresult`: actual 264 through full generation/material placement and saved-book determinism; Q0–5 and valid/refused single-cell cases; old-policy and existing mixed-water/channel behavior; durable connected Salve/next-Bind save retry. Actual 264 retains standing/flowing/frozen 0/4/102, two flowing channels of two cells, and twelve material sources with reachable work positions. Design accepts this bounded runtime closure. No full corpus was rerun or historical counts replaced. Written Iron, natural pacing, material presentation and phone cutover remain outstanding; gate off, phone 306 unchanged.
