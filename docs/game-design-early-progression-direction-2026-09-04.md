...
**Current delivered baseline — phone331:** the complete connected opening below is delivered for new campaigns, retaining the early makers/tools and329–330 presentation corrections. Zero ownership, protected introduction/continuation, owned-only first Sun writing, practical lesson pairs, all-route missing Subjects, former starter sources,13 usable Modifiers and first-six selection ship together. Existing campaigns retain progress. Engineering’s bounded native/rules receipt below establishes the implemented paths; it does not establish final natural pacing or Aimee acceptance.

**Design-authored first pass, delivered in331:** the connected stages, protected four practical lessons, missing vocabulary routes and first-six selection adjustment below. These are explicit replacements under the whole-opening assignment, not claims that Aimee personally selected each tuning detail. No new personal decision is required to implement this first pass; natural pacing remains something to learn from play.
...
| Broader Modifiers | Opening instruction after the above: Minute/Small and Single/Pair; developing instruction: Great, Large, Few/Many; later instruction: Overwhelming, Vast, Countless | One lesson record per word, current ordinary instruction opportunity/protection and band gates. Fixed teaching texts explain the existing ladder meanings; do not infer sizes/counts from sprites; phase teaching is deferred |
...
**Acquisition-route closure:** missing-Subject support applies to every lawful Focus acquisition route, including cache/world rewards, diary teaching and retained research; it is not exclusive to a selected recovered-teaching object. Preserve each route’s own eligibility, exclusivity and payment. Its actual acquired Focus/teaching receipt is sufficient provenance for a separately named free prerequisite Subject lesson; do not require another sighting, another expedition, a shop or the Subject itself to create that lesson. It grants the Subject only, not another Focus or another cache reward. Reuse the same canonical Subject reward identity and idempotent read owner across all routes.

When an owned Focus legally attaches to several Subjects, its Library entry offers the still-missing applicable Subject lessons separately using that real owned-source record. This also covers a source learned earlier or the second use of River/Granite; the existing `rewardIsKnown(focus)` candidate filter must not suppress missing Subject acquisition. A physical Page containing an unknown word is not an acquired Focus receipt. Diary-exclusive Focuses still require their actual diaries. Cycle therefore has real independent routes through lawful Stillness, Tide or Orrery acquisition and their prerequisite lesson, without needing a later Cycle-dependent traveler first. This is an explicit connected-opening integration requirement, not a claim that current cache grants already implement it.

**Atomic delivery boundary:** the empty start, safe two-word introduction, unqualified first writing, all-route missing-Subject handling, actual former-starter source lessons and qualifier ownership/read handling are one connected opening change. Do not release a zero-word new game while one of these is left as a later Scriptorium/shop task. The later ink/Compound/hand upgrades are not prerequisites for the initial implementation. Preserve existing normal acquisition of authored Compounds where that route already exists; no copied Page grants and no new guaranteed Compound drop.
...
**Phase correction — supersedes the earlier all17 lesson requirement:** Frozen, Solid, Liquid and Vaporous are dormant catalogue definitions, deliberately excluded from new writing because they have no honest live hydrology effect. Do not teach them as reference-only rewards or enable inert writing to satisfy an ownership checklist. Remove them from the developing lesson band and all due-lesson/completion requirements; no opening route may depend on them. Preserve existing saved IDs, tolerant old-page decoding and existing warnings without adding a new grant. The generic ownership representation may retain those IDs for preservation, but new lesson content teaches only the13 usable intensity/scale/count words. Phase lessons require a meaningful implemented writing consumer before they can return; that later work is outside this opening and does not hold its release. This corrects a Design first-pass error, not an instruction to add phase physics.

**Content implementation:** add canonical `target` records for all8 Subjects, field `focus` records for the formerly starter-only sources above, and a typed `qualifier` reward/owned set with acquisition lessons for the13 usable intensity/scale/count qualifiers. Use existing definitions/names/ladder semantics as instruction authority. Basic copy: **“Faint changes how strongly a source contributes; it does not mean a small source.”** **“Small describes extent, Pair describes count. They are different choices.”** Preserve focus versus similarly named danger-rune identity. No new Coal, Clay, Resin or timber Focus is created by this opening plan.
...
## Invitation/menu delivery boundary — phone329

Source `d3f57c6145f1e49c2a895edf28e3156babad0c6d`, tree `ab5a7a8a77899a6a0f0859ebcd1a99efffbd3a5d`, installed2026-09-07T02:33:50Z on Aimee’s iPhone16Pro. Automatic ordinary launch was refused while the phone was locked; installation succeeded. Invite Them uses the existing recruitment owner with no decline control; the unrequested wood-colour trial menu entry is gone, requested3D entries retained. Actual-target Simulator invitation checks passed. Evidence: Engineering’s phone-build-329-delivery-2026-09-06.md and phone-329-ui-and-3d-corrections-2026-09-06.md. No Design native/phone verification. This does not deliver the connected opening, change roster bands, or include retained Armoury WIP. Essence recovery remains deferred.


## Phone330 continuity

Delivered source `03b927f0e0840f49c81afa06e397448f11a12d32`, tree `09f04470c7f6594ac25647fae6f41642318d44f6`; install and ordinary launch succeeded. Seven Engineering checks cover the bounded viewport/material-display corrections recorded in `ordinary-3d-expedition-trial-v1.md`. These corrections do not implement this connected opening. Engineering confirmed this master and its every-lawful-Focus missing-Subject closure as the next implementation, with Essence recovery deferred and Armoury excluded. No Design native/phone re-verification.


## Connected opening delivery — phone331

Source `7b612caa36af396c106a4eb4811741c261ae9b81`, tree `d22e85c25ac2f5be20ec62155d64ff67b7df369a`, delivery doc commit `33c1263b`, Engineering branch `codex/connected-opening-v1`, clean at handoff. Installed2026-09-07T04:04:23.222923Z, device readback331, iPhone16Pro402×874pt/1206×2622px/default text. Ordinary launch refused solely because phone locked; no launch-success or Aimee acceptance claim. Existing phone save untouched.

Engineering’s same persistent native acceptance campaign collected both lessons, returned, read both through Home, reopened, joined Illumination/Sun and reached its actual14-Essence Bind quote. The native result passed four checks including three ownership/durability cases. Relevant rules regression passed14 checks with two historical-policy fixtures corrected separately. The final extended rules proof completed partial intro collection/reading, same-world continuation, first authored Sun Bind/outcome, Faint/Moderate records/read/reopen. Other supplied rules cover practical paired lessons, lawful Focus prerequisites/diaries, traveler selection and source→harvest→recruit→Apothecary→Salve→later use with failed-write/current-corruption handling. These are distinct bounded native and rules scopes, not a fully natural multi-expedition native campaign.

Simulator iPhone17Pro/iOS26.2 at402×874pt/1206×2622px/default text/current dark appearance matched the target viewport; no matrix. Evidence: Engineering `docs/phone-331-connected-opening-2026-09-06.md` and `docs/phone-build-331-delivery-2026-09-06.md`. No concrete conflict with the reconciled master is identified in these receipts. No Design native/phone repeat. Phase remains deferred, Armoury paused pending PM priority, Essence recovery excluded; natural pacing still awaits play feedback.


## Native first Sun follow-through — unchanged phone331 source

Engineering evidence/test commit `0fb75f91b81270e2e2b560d3e4e4a4d638196a0d`, `docs/connected-opening-native-first-sun-receipt-2026-09-06.md`, continues the same preserved acceptance campaign on application source `7b612caa36af396c106a4eb4811741c261ae9b81`. Exactly next generated seed18201609923829866926; native joined Sun Bind, actual Substrate/Iron paired lesson pickup, portal Return after two movement turns, four free Library reads including outcome-backed Faint/Moderate, reopen and available17-Essence Faint→Sun→Illumination quote. Quote not bought. Endpoint22 Essence, issuance2/outcome2, all6 lessons read; no active run, grants, reset, candidate search or third expedition. No harvest, recruit or combat exercised; no claim of absence elsewhere.

Supplied native checks completed with test-selector/navigation/gesture corrections only, no application change. iPhone17Pro Simulator/iOS26.2,402×874pt/1206×2622px/default text/current dark appearance matching target viewport, ordinary2D. This extends native evidence beyond the prior first-Sun quote; no new install or Design rerun. No substantive gameplay blocker found on this bounded route.

Observed presentation gap: Return permanent gains omit the newly acquired lesson names although Library records/read permissions persist. Design disposition: surface only actual newly earned saved lesson names with their readable-at-Home next step; do not grant or read knowledge from the receipt, and do not imply an additional reward. PM already owns priority for this small correction. Natural pacing remains open; Armoury/later shops remain paused and Essence recovery excluded.


**Bounded Return copy — intended correction assigned by PM:** heading **New lessons**; rows use the existing Library record titles and actual saved state **Ready to read** or **Read**. If any are unread: **Read these lessons in the Library at Home to learn their words.** If all are read: **Saved in your Library.** Include the actual newly earned field records and outcome-backed instructions for this expedition once; omit prior unrelated records and the empty section. Use existing Return→Home→Library/Read Lessons navigation. A receipt displays earned lessons; only the established reading action learns their words. Reopening may reflect current read state but never creates another reward.


## Return lesson correction delivered — phone332

Source `01d776dff9ffe158f3bcf040f5e0df3b8d440a37`, tree `2625dcea25c90ce15531765cd60ed5b42a21ed08`, delivery commit `89928df0`. Installed2026-09-07T05:02:09.579030Z on iPhone16Pro402×874pt/1206×2622px/default text, readback332; ordinary launch succeeded, existing phone save unchanged. The pending Return gap above is now closed: exact outcome-matched validated records supply stored titles and current Ready to read/Read states, Design support copy, empty omission and exclusion of older/unearned entries. Read lessons durably acknowledges the ordinary Return before opening existing Home Library; failed acknowledgment does not navigate. No auto-learning, new record or duplicated reward.

Four focused checks cover membership/status, acknowledgment without learning/duplication, retained quote identity and failed-write/recovery/replay. A native attached-window render was inspected at iPhone17Pro Simulator/iOS26.2,402×874pt/1206×2622px/default text/current dark appearance matching target viewport. It used a disposable copy of the preserved endpoint with outcome2 records replayed as unread; this is bounded presentation evidence, not another expedition or end-to-end playthrough. Original endpoint remains Home22 Essence,2 issued worlds/outcomes,6 lessons read. Evidence: Engineering `docs/phone-build-332-delivery-2026-09-06.md` and `docs/phone-332-return-new-lessons-2026-09-06.md`. No Design duplicate native/phone/live checks; Aimee visual acceptance remains separate. Later shops, Armoury and Essence recovery remain excluded.
