...
At a maximum level-3 facility, a craft using only Rare or Exceptional quality-bearing inputs has a 3% chance to become Peerless. The chance is 5% when the matching specialist is staffing that facility. The twentieth consecutive eligible craft of the **same schematic at the same facility** is guaranteed to be Peerless; an eligible Peerless result resets only that schematic's counter. The quote freezes the result before commitment, and the current progress is visible rather than hidden. Cheap crafts in another family cannot prepare a costly object to become Peerless. Peerless remains a finished-equipment quality, never a raw-material quality and never a progression gate.
