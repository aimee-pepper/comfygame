...
for(const ground of ["soil","water","deepWater"])for(const adjacency of [0,5,10,15])current[`terrain/${ground}/${adjacency}`]=rasterHash(transitionedTerrainCommands({ground,adjacency,revealed:true,speciesSeed:404}),16,16);
