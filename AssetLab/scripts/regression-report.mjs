...
import { catalogueItemIDs,catalogueItemIconCommands,unknownItemIconCommands,tier2CatalogueItemIDs,tier2CatalogueItemIconCommands,tier3CatalogueItemIDs,tier3CatalogueItemIconCommands } from "../src/item-kit.js";
...
for(const id of catalogueItemIDs)current[`item/${id}/inventory`]=rasterHash(catalogueItemIconCommands(id),32,32);
for(const id of tier2CatalogueItemIDs)current[`item/${id}/inventory`]=rasterHash(tier2CatalogueItemIconCommands(id),32,32);
for(const id of tier3CatalogueItemIDs)current[`item/${id}/inventory`]=rasterHash(tier3CatalogueItemIconCommands(id),32,32);
current["item/unknown/inventory"]=rasterHash(unknownItemIconCommands(),32,32);
